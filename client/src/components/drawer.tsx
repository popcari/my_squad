  ...
  return (
    <>
      ...
      <aside
        ...
        aria-modal="true"
        aria-label={title}
        className={`fixed top-0 right-0 bottom-0 z-50 w-full md:w-[500px] bg-card border-l border-border shadow-2xl flex flex-col transition-transform duration-200 ease-out ${
